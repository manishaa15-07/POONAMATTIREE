...
/*
 * POPULATE HOMEPAGE SCRIPT
 * 
 * This script DELETES ALL EXISTING PRODUCTS and creates fresh ones.
 * Use this when you want to completely reset the database.
 * 
 * For updating existing products without deleting everything, use:
 * node update-homepage.js
 * 
 * WARNING: This will remove ALL products from the database!
 */
...
async function populateHomepage() {
    try {
        ...
        // Clear ALL existing products first to prevent duplicates
        ...
        for (const product of featuredProducts) {
            ...
            console.log(`✅ Added featured product: ${product.name}`);
        }
        ...
        for (const product of recommendedProducts) {
            const newProduct = new Product(product);
            await newProduct.save();
            console.log(`✅ Added recommended product: ${product.name}`);
        }

        console.log('✅ Homepage products populated successfully!');
